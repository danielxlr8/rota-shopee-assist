      ...
      <div
        ...
        style={
          theme === "dark"
            ? {
                boxShadow:
                  "0 20px 40px -10px rgba(238, 77, 45, 0.2), 0 0 0 1px rgba(238, 77, 45, 0.1)",
              }
            : {
                boxShadow:
            ...
            >
              {driver.avatar ? (
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, rgba(255, 168, 50, 0.8) 0%, rgba(254, 95, 47, 0.9) 100%)",
                  }}
                >
            ...
            <div className="mb-3">
              ...
              >
                ...
                <span className="font-medium">
                  {driver.hub
                    ? driver.hub.split("_")[2] || driver.hub
                    : "Sem Hub"}
                </span>
              </div>
            </div>
